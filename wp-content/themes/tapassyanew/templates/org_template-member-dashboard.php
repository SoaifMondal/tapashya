...
<section class="exit-section about-section">
  	<div class="container">
		...
		<?php } if(!current_user_can('student') && get_user_meta($current_user->ID, 'member_responsibility', true) == 'hes-admin' || current_user_can('administrator')){ ?>
