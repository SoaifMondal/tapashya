<?php 
/*Template Name: Template Account Credit*/
get_header();
global $wpdb;
				...
				<div class="col-md-12">
					...
					<div class="row">
						...
						<div class="col-12">
							...
							<a href="<?php echo home_url('account-credit-insert-form')  ?>" class="btn btn-primary" style="color:#fff">Add New</a>
				                <h3>Credit List</h3>
		        						...
		        						if($wpdb->num_rows > 0){
				                  		...
				                  		?>
					                        <tr>
											  ...
											  <th><a href="#" class="edit-credit" data-credit-id="<?php echo $result->ID; ?>" data-amount-recived="<?php echo $result->amount_received; ?>" title="Edit"><i class="fas fa-edit"></i></a></th>
...
<div class="modal fade bd-example-modal-lg" id="creditEditModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
